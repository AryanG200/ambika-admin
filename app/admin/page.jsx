      ...
      <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <h3 className="text-black text-2xl font-bold">₹{analytics.metrics.totalRevenue.toLocaleString()}</h3>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <h3 className="text-black text-2xl font-bold">{analytics.metrics.totalOrders}</h3>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <h3 className="text-black text-2xl font-bold">{analytics.metrics.totalUsers}</h3>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <h3 className="text-black text-2xl font-bold">₹{analytics.metrics.averageOrderValue.toFixed(2)}</h3>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center space-x-2">
            <select className="text-black text-xs border border-gray-300 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            ...
            {activeTab === "products" && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <form onSubmit={handleSubmitProduct} className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          <label className="text-black block text-sm font-medium text-gray-700 mb-1">Description</label>
                          <textarea
                        ...
                        <div>
                          <label className="text-black block text-sm font-medium text-gray-700 mb-1">Price (₹)</label>
                          <input
                            type="number"
                        ...
                        <div>
                          <label className="text-black block text-sm font-medium text-gray-700 mb-1">Quantity</label>
                          <input
                            type="number"
                        ...
                        <div>
                          <label className="text-black block text-sm font-medium text-gray-700 mb-1">Category</label>
                          <input
                            type="text"
                      ...
                      <div>
                        <label className="text-black block text-sm font-medium text-gray-700 mb-1">Product Image</label>
                ...
                <div className="lg:col-span-2">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <h2 className="text-black text-xl font-semibold mb-4">Product List</h2>
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200">
                        <thead>
                          <tr>
                        ...
                        <tbody className="divide-y divide-gray-200">
                          {products.map((product) => (
                            <tr key={product._id}>
                              ...
                              <td className="text-black px-6 py-4">{product.name}</td>
                              <td className="text-black px-6 py-4">{product.category}</td>
                              <td className="text-black px-6 py-4">₹{product.price}</td>
                              <td className="text-black px-6 py-4">{product.quantity}</td>
